...
$labelIndicadores="Indicadores";
$labelIndicadores="Indicadores del " . $fechaVisita . "." . " UF:$" . $valorUF . " | UTM:$" . $valorUTM . " | Dólar:$" . $valorDolar . " | Euro:$" . $valorEuro; 
registraVisita();
